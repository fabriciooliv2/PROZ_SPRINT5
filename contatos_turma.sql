...
CREATE TABLE `turma` (
  ...
  `data_de_matricula` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id_matricula`),
  KEY `fk_id_usuario_idx` (`fk_id_usuario`),
  KEY `fk_id_servico_idx` (`fk_id_servico`),
...
INSERT INTO `turma` VALUES (4,1,NULL,'15/09/2024'),(5,2,NULL,'10/09/2024'),(6,3,NULL,'01/08/2024');
