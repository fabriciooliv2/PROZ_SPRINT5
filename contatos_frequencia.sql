...
CREATE TABLE `frequencia` (
  ...
  `data_f` varchar(10) DEFAULT NULL,
  `presenca` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id_frequencia`),
  KEY `fk_id_matricula_idx` (`fk_id_matricula`),
  CONSTRAINT `fk_id_matricula` FOREIGN KEY (`fk_id_matricula`) REFERENCES `turma` (`id_matricula`)
...
INSERT INTO `frequencia` VALUES (1,NULL,'20/09/2024',10),(2,4,'20/09/2024',10),(3,6,'20/09/2024',9);
